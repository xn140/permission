 ...
 */
@Service
public class SysAclModuleServiceImpl  implements SysAclModulService{
    @Autowired
    ...
    Preconditions.checkNotNull(sysAclModule,"待删除的权限模块为空，无法删除");
      ...
      if(sysAclMapper.countByAclModuleId(sysAclModule.getId())>0){
          throw new ParamException("待删除模块下有权限，无法删除");
    ...
    private boolean checkExit(Integer parentId, String aclModuleName, Integer deptId){
